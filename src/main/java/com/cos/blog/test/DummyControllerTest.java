...
//		UserRepository.save(user);
	...
	//페이징처리! 한페이지당 2건의 데이터를 리턴받아볼예정 (27-6~7분) 어려움..
	...
	public String join(User user) { //key-value(약속된규칙)로 전송-> user로 하면 한번에!
		...
		user.setRole(RoleType.USER); //enum을 활용해서 강제! 실수방지~
		UserRepository.save(user); //save는 insert할때 사용
